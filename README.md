...
- 4 roles, 1 default specialist, 5 skills, 5 doc templates, 3 CI templates. That's the whole kit — resist the urge to add a role, skill, or document for every idea; `CLAUDE.md` §3 and `INITIATION.md` §3 exist specifically to block that drift.
